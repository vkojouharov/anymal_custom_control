...
if __name__ == "__main__":
    ...
    plot_task_smooth(task1, optimal_traj1, save_path="planning/plots/demo1/optimal_traj_0.5.png")
    plot_task_smooth(task2, optimal_traj2, save_path="planning/plots/demo1/optimal_traj_1.5.png")
