...
Usage:
    python planning/plot_scp_result.py                        # saves to plots/
    python planning/plot_scp_result.py --csv path/to/scp.csv  # custom CSV
    python planning/plot_scp_result.py --show                  # display instead of save
"""
import argparse
import csv
import os
