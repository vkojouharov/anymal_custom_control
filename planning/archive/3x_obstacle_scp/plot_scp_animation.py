...
Usage:
    python planning/scp_obstacle_traj_animate.py
    python planning/scp_obstacle_traj_animate.py --csv path/to/scp_history.csv
    python planning/scp_obstacle_traj_animate.py --out path/to/output.gif
"""
import argparse
import csv
import os
